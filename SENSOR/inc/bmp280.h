...
typedef enum {
	...
	BMP280_T_MODE_4,						/*x8*/
	BMP280_T_MODE_5			    		/*x16*/
} BMP280_T_OVERSAMPLING;			// 温度过采样率
 
typedef enum {
	BMP280_SLEEP_MODE = 0x0,		// 休眠模式
	BMP280_FORCED_MODE,					// 触发模式
	BMP280_NORMAL_MODE					// 正常模式
} BMP280_WORK_MODE;
...
} BMP280_FILTER_COEFFICIENT;	// 滤波系数
